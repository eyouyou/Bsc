    ...
    public class FileEntry : FileResource
    {
        ...
        public string RelativePath
        {
            get
            {
                if (RootDir == null)
                {
                    throw new BscException("The root dir is null.");
                }
        ...
        public bool IsImage
        {
            get
            {
                return ImageTools.IsImageExtension(this.FileExtension);
            }
        }
    ...
    public abstract class FileManager
    {
        ...
        public virtual void LocalizeFile(Site site, string fileRelativePath)
        {
            ...
            if (!targetFileEntry.Exists())
            {
                ...
                if (fileEntry != null)
                {
                    IOUtility.EnsureDirectoryExists(Path.GetDirectoryName(targetFileEntry.PhysicalPath));

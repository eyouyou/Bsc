...
namespace Bsc.Dmtds.Sites.Extension.ModuleArea.Runtime
{
    public static class ModuleExecutor
    {
        ...
        private static void InitializeController(Controller moduleController, ModuleRequestContext moduleRequestContext)
        {
            ...
            if (View.Page_Context.Current.PageRequestContext != null)
            {
                valueProvider.Add(new NameValueCollectionValueProvider(View.Page_Context.Current.PageRequestContext.AllQueryString, System.Globalization.CultureInfo.InvariantCulture));
            }

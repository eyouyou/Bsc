...
using Bsc.Dmtds.Content.Query.Translator.String;
...
namespace Bsc.Dmtds.Sites.DataRule
{
    ...
    public abstract class DataRuleBase : IContentDataRule
    {
        ...
        private static object GetCacheData(IContentQuery<TextContent> contentQuery, TakeOperation operation,
            CacheItemPolicy policy, Func<object> getData)
        {
        ...
        public virtual bool HasAnyParameters()
        {
            ...
            if (WhereClauses != null)
            {
                ...
                {
                    if (ParameterizedFieldValue.IsParameterizedField(item.Value1) ||
                        ParameterizedFieldValue.IsParameterizedField(item.Value2))
                    {
                        return true;
                    }
                }

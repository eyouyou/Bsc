...
namespace Bsc.Dmtds.Sites.View
{
    ...
    public class PageRequestContext
    {
        ...
        public PageRequestContext(ControllerContext controllerContext, Site site, Page page,
        ...
        public Sites.DataRule.ValueProviderCollection GetValueProvider()
        {
            return new Sites.DataRule.ValueProviderCollection(new List<Sites.DataRule.IValueProvider>()
            {
                new Sites.DataRule.FormValueProvider(this.ControllerContext),
                new RouteValueProvider(this),
                new Sites.DataRule.QueryStringValueProvider(this.ControllerContext),

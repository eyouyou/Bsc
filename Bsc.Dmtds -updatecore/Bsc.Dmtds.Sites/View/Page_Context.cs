...
namespace Bsc.Dmtds.Sites.View
{
    ...
    public class Page_Context
    {
        ...
        public static Page_Context Current
        {
            get
            {
                return EngineContext.Current.Resolve<Page_Context>();
            }
        }
        #endregion
        ...
        internal bool InlineEditing
        {
            get
            {
                ...
                return
                    ...
                    && ServiceFactory.UserManager.Authorize(Page_Context.Current.PageRequestContext.Site, Page_Context.Current.ControllerContext.HttpContext.User.Identity.Name,Permission.Sites_Page_PublishPermission)
                    );
            }
        }

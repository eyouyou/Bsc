...
namespace Bsc.Dmtds.Sites.Models
{
    ...
    public partial class Page : DirectoryResource, IInheritable<Page>, Versioning.IVersionable
    {
        #region EmptyPage
        ...
        public override bool Exists()
        {
            ...
            return Bsc.Dmtds.Sites.Persistence.Providers.PageProvider.Get(this) != null;
        }
        #endregion
    }
}
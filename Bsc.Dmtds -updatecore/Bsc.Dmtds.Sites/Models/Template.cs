...
{
    public abstract class Template : DirectoryResource, ISiteObject, IFilePersistable, IPersistable, IIdentifiable, Sites.Versioning.IVersionable
    {
        protected Template()
        {
        }
        ...
        public virtual string TemplateFileVirutalPath
        {
            get
            {
                return System.Web.HttpUtility.UrlDecode(UrlUtility.Combine(base.VirtualPath, TemplateFileName));
            }
        }
        #endregion

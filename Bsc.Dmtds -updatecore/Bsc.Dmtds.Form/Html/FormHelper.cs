...
namespace Bsc.Dmtds.Form.Html
{
    public static class FormHelper
    {
        ...
        static FormHelper()
        {
            ...
            TemplateDir = Path.Combine(baseDir.DataPhysicalPath, "ContentType_Templates", "Forms");
            TemplateVirtualPath = UrlUtility.Combine(baseDir.DataVirtualPath, "ContentType_Templates", "Forms");

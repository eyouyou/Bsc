...
////                PhoneNumber = await _userService.GetPhoneNumber(userId),
////                TwoFactor = await _userService.GetTwoFactorEnabled(userId),
//                Logins = await _userService.GetLogins(userId),
...
//            var result = await _userService.RemoveLogin(User.Identity.GetUserId(), new UserLoginInfo(loginProvider, providerKey));
//            if (result.Succeeded)
//            {
...
//                return View(model);
//            }
//            var result = await _userService.ChangePassword(User.Identity.GetUserId(), model.OldPassword, model.NewPassword);
//            if (result.Succeeded)
//            {
//                var user = _userService.FindById(User.Identity.GetUserId());
//                if (user != null)
...
//            if (ModelState.IsValid)
//            {
//                var result = await _userService.AddPassword(User.Identity.GetUserId(), model.NewPassword);
//                if (result.Succeeded)
//                {
//                    var user = _userService.FindById(User.Identity.GetUserId());
//                    if (user != null)
...
//                return View("Error");
//            }
//            var userLogins = await _userService.GetLogins(User.Identity.GetUserId());

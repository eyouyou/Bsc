...
namespace Bsc.Dmtds.Core.Reflection
{
    public class Properties
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="System.Object" /> 用具体的名字.
        /// </summary>
        /// <value>
    ...
    public static class PropertyExtensions
    {
        ...
        {
#if CONTRACT
            Contract.Requires<ContractException>(source != null, "源不能为空.");
            Contract.Requires<ContractException>(!string.IsNullOrEmpty(propertyName), "属性名不能为空.");
#endif
            ...
            {
                throw new MemberException(e.Message + "属性名:" + propertyName, e);
            }
        ...
        private static PropertyInfo GetPropertyInfo(Type type, string propertyName, bool throwException)
        {
            ...
            {
                throw new MemberNotFoundException(string.Format("属性名 \"{0}\" 不能被找到在 \"{1}\"", propertyName, type.ToString()))
                {
        ...
        private static void SetStrongTypePropery<T, TProperty>(T source, string propertyName, TProperty value, bool throwException = true)
        {
            ...
            {
                throw new MemberException(e.Message + "类型名:" + propertyName, e);
            }
        }

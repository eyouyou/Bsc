...
namespace Bsc.Dmtds.Caching
{
    ...
    {
        #region Properties
        public static CacheItemPolicy DefaultCacheItemPolicy = new CacheItemPolicy()
        {
        ...
        public static void SetExpired(this ObjectCache objectCache, string cacheKey)
        {
            ...
            if (cacheItem != null)
            {
                objectCache.Set(cacheItem, new CacheItemPolicy() { AbsoluteExpiration = new DateTimeOffset(DateTime.Now) });
            }
        }
        #endregion 
    }

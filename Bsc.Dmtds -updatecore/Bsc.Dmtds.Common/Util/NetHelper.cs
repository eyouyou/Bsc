...
//            GetDnsRealHost();
        ...
        public static bool SendEmail(string receiveEmail, string msgSubject, string msgBody, bool IsEnableSSL)
        {
            ...
            email.From = new MailAddress("s393370459@163.com","BMTDS - MR.SUN");
            //设置接收人的电子邮件地址
            ...
            client.Credentials = new NetworkCredential("s393370459@163.com", "1188721872008");
...
/*        private static string GetDnsRealHost()
        {
            ...
            {
                GetDomainStr("dt_cache_domain_info", ts);
            }
            return host;
        }*/
        /// <summary>

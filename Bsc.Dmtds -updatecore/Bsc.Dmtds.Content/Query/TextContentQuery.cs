...
namespace Bsc.Dmtds.Content.Query
{
    ...
    {
        public ParentQuery(Repository repository, Schema parentSchema, TextFolder parentFolder,
            IContentQuery<TextContent> childrenQuery)
        ...
        public ParentQuery(Repository repository, Schema parentSchema, TextFolder parentFolder,
            IContentQuery<TextContent> childrenQuery, IExpression expression)
            : base(repository, expression)
        {

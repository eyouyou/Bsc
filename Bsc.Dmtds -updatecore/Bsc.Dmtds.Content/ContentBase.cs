...
namespace Bsc.Dmtds.Content
{
    ...
    public partial class ContentBase : DynamicDictionary
    {
        ...
        public DateTime CreationDate
        {
            get
            {
                if (this.ContainsKey("CreationDate") && base["CreationDate"] != null && base["UtcCreationDate"] is DateTime)
                {
                    return (DateTime)base["CreationDate"];
                }
        ...
        public DateTime LastModificationDate
        {
            get
            {
                if (this.ContainsKey("LastModificationDate") && base["LastModificationDate"] != null && base["UtcLastModificationDate"] is DateTime)
                {
                    return (DateTime)base["LastModificationDate"];
                }
                return DateTime.UtcNow;
            }
            set
            {
                base["LastModificationDate"] = value;
            }
        }

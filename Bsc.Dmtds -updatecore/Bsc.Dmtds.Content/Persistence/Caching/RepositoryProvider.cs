    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        public Models.Repository Get(Models.Repository dummy)
        {
            ...
            if (o == null)
            {
                ...
                dummy.ObjectCache().Add(cacheKey, o, Bsc.Dmtds.Caching.ObjectCacheExtensions.DefaultCacheItemPolicy);
            }
            return o;
        }
        #endregion
        ...
        public void Add(Models.Repository item)
        {
            ...
            {
                Bsc.Dmtds.Caching.CacheManagerFactory.DefaultCacheManager.ClearGlobalObjectCache();
            }
        }
        #endregion

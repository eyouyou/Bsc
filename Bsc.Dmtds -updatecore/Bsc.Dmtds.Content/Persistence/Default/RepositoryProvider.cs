...
{
    [Bsc.Dmtds.Core.Runtime.Dependency.Dependency(typeof(IRepositoryProvider))]
    [Bsc.Dmtds.Core.Runtime.Dependency.Dependency(typeof(IProvider<Repository>))]
    public class RepositoryProvider : FileSystemProviderBase<Repository>, IRepositoryProvider
    {
        ...
        public virtual void Offline(Repository repository)
        {
            ...
            {
                File.WriteAllText(offlineFile, "The repository is offline, please remove this file to take it online.");
            }
        }
